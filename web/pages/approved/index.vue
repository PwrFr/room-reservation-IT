<template>
    <v-app class="my-4 mx-4 rounded-3xl">
        <v-container grid-list-xs >
            <h1 class="text-3xl font-bold text-right mb-8">หน้าอนุมัติการจอง</h1>
                    ...
                    <v-hover v-slot="{ hover }">
                        <v-card :elevation="hover ? 12 : 2" :class="{ 'on-hover': hover }">
                            <v-row no-gutters align="center">
                                ...
                                <v-col cols="12" sm="3" md="3" class="py-6 pl-3">
                                ...
                                <v-col cols="12" sm="2" md="2" class="py-6 pl-3">
                                    <span class="font-bold">
                                        Status
                                    </span><br>
                                    {{ item.status }}
...
export default {
    data: () => ({
        ...
        items: [
            {
                room: "M22",
                reserveDate: "22/5/2022 10:15:20",
                attendee: "60",
                status: "Pending..."
            ...
            {
                room: "M23",
                reserveDate: "23/5/2022 10:15:20",
                attendee: "61",
                status: "Pending..."
            ...
            {
                room: "M24",
                reserveDate: "24/5/2022 10:15:20",
                attendee: "62",
                status: "Pending..."
